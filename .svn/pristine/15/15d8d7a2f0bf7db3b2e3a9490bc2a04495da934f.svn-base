	...
	public String doDeviceDailyUsagesConsolidation(
		...
		try{
			if (dateFrom != null && dateTo != null && orgId != null){
				...
				Calendar calFrom = ConsolidateJobsHelper.convertParamDateString2Calendar(dateFrom);
				CalendarUtils.trimCalendar2Minimum(calFrom);
				Calendar calTo = ConsolidateJobsHelper.convertParamDateString2Calendar(dateTo);
